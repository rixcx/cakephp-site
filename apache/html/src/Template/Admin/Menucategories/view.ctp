...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Menucategory'), ['action' => 'edit', $menucategory->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Menucategory'), ['action' => 'delete', $menucategory->id], ['confirm' => __('Are you sure you want to delete # {0}?', $menucategory->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Menucategories'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Menucategory'), ['action' => 'add']) ?> </li>
